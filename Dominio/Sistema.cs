...
namespace Dominio
{
    public class Sistema
    {
        ...
        private List<PartidoEliminatoria> partidosEliminatoria = new List<PartidoEliminatoria>();
        public List<PartidoEliminatoria> PartidosEliminatoria
        {
            get
            {
        ...
        private List<PartidoGrupo> partidosGrupo = new List<PartidoGrupo>();
        public List<PartidoGrupo> PartidosGrupo
        {
            get
            {
        ...
        private Seleccion BuscarSeleccionGanadora(string nombre)
        {
            foreach(Seleccion s in selecciones)
            {
                if (s.unPais.Nombre.Equals(nombre)) return s;
            }
            throw new Exception("La seleccion ganadora no se encontro");
        }
        ...
        private void AltaPartido(Partido p)
        {
            this.Partidos.Add(p);
        }
        ...
        private void PrecargaPartidos()
        {
            ...
            AltaPartido(new PartidoGrupo("A", 1, buscarSelecciones("Catar", "Ecuador"), DateTime.Parse("2022-11-08 10:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 2, buscarSelecciones("Catar", "Senegal"), DateTime.Parse("2022-11-08 10:00:00"), "Finalizado", "Fase de grupos", null));

            
            AltaPartido(new PartidoGrupo("A", 3, buscarSelecciones("Catar", "Países Bajos"), DateTime.Parse("2022-11-09 13:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 4, buscarSelecciones("Ecuador", "Catar"), DateTime.Parse("2022-11-10 16:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 5, buscarSelecciones("Ecuador", "Senegal"), DateTime.Parse("2022-11-11 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 6, buscarSelecciones("Ecuador", "Países Bajos"), DateTime.Parse("2022-11-12 13:00:00"), "Finalizado", "Fase de grupos", null));


            AltaPartido(new PartidoGrupo("A", 7, buscarSelecciones("Senegal", "Catar"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 8, buscarSelecciones("Senegal", "Ecuador"), DateTime.Parse("2022-11-11 16:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 9, buscarSelecciones("Senegal", "Países Bajos"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos", null));


            AltaPartido(new PartidoGrupo("A", 10, buscarSelecciones("Países Bajos", "Catar"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 11, buscarSelecciones("Países Bajos", "Ecuador"), DateTime.Parse("2022-11-11 10:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("A", 12, buscarSelecciones("Países Bajos", "Senegal"), DateTime.Parse("2022-11-12 13:00:00"), "Finalizado", "Fase de grupos", null));

            /*********************************************************GRUPO B*********************************************************/

            AltaPartido(new PartidoGrupo("B", 13, buscarSelecciones("Inglaterra", "Irán"), DateTime.Parse("2022-11-07 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 14, buscarSelecciones("Inglaterra", "Gales"), DateTime.Parse("2022-11-08 16:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 15, buscarSelecciones("Inglaterra", "Estados Unidos"), DateTime.Parse("2022-11-09 13:00:00"), "Finalizado", "Fase de grupos", null));


            AltaPartido(new PartidoGrupo("B", 16, buscarSelecciones("Irán", "Inglaterra"), DateTime.Parse("2022-11-10 16:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 17, buscarSelecciones("Irán", "Gales"), DateTime.Parse("2022-11-11 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 18, buscarSelecciones("Irán", "Estados Unidos"), DateTime.Parse("2022-11-12 16:00:00"), "Finalizado", "Fase de grupos", null));


            AltaPartido(new PartidoGrupo("B", 19, buscarSelecciones("Estados Unidos", "Irán"), DateTime.Parse("2022-11-10 16:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 20, buscarSelecciones("Estados Unidos", "Gales"), DateTime.Parse("2022-11-11 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 21, buscarSelecciones("Estados Unidos", "Inglaterra"), DateTime.Parse("2022-11-12 16:00:00"), "Finalizado", "Fase de grupos", null));


            AltaPartido(new PartidoGrupo("B", 22, buscarSelecciones("Gales", "Irán"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B", 23, buscarSelecciones("Gales", "Inglaterra"), DateTime.Parse("2022-11-11 16:00:00"), "Finalizado", "Fase de grupos", null));

            AltaPartido(new PartidoGrupo("B",24, buscarSelecciones("Gales", "Estados Unidos"), DateTime.Parse("2022-11-12 10:00:00"), "Finalizado", "Fase de grupos", null));

            /*********************************************************Octavos*********************************************************/

            AltaPartido(new PartidoEliminatoria(BuscarSeleccionGanadora("Ecuador"), true, true, "Semis", 25, buscarSelecciones("Ecuador", "Gales"), DateTime.Parse("2022-12-18 12:00:00"), "Finalizado", "Eliminatoria", null));

            AltaPartido(new PartidoEliminatoria(BuscarSeleccionGanadora("Inglaterra"), false, false,"Semis", 26, buscarSelecciones("Inglaterra", "Países Bajos"), DateTime.Parse("2022-12-18 12:00:00"), "Finalizado", "Eliminatoria", null));

            /*********************************************************Final*********************************************************/

            AltaPartido(new PartidoEliminatoria(BuscarSeleccionGanadora("Inglaterra"), false, false,"Final", 27, buscarSelecciones("Inglaterra", "Ecuador"), DateTime.Parse("2022-12-18 12:00:00"), "Pendiente", "Eliminatoria", null));
        ...
        {
            Registrar(new UsuarioPeriodista("Juan", "JuanPerez1972", "JuanPerez@gmail.com", "Perez"));
            Registrar(new UsuarioPeriodista("Juan", "Alvez4233", "AlvezJuan@gmail.com", "Alvez"));
            Registrar(new UsuarioPeriodista("Alberto", "AlbertoBleeeeez1", "b123Blazi@gmail.com", "Blezi"));
            Registrar(new UsuarioPeriodista("Hector", "Perro6643", "lagunaHector@gmail.com", "Laguna"));
            Registrar(new UsuarioPeriodista("Diego", "Diegote1566", "PirizD@gmail.com", "Piriz"));
            Registrar(new UsuarioPeriodista("Juan", "JuanJuanSom221", "JuanSomm@gmail.com", "Som"));
            Registrar(new UsuarioPeriodista("Juan", "Villamil555", "JuanVillamil@gmail.com", "Villamil"));
            Registrar(new UsuarioPeriodista("Juan", "JuanLLagun..2", "LJuan@gmail.com", "Laguna"));
            Registrar(new UsuarioPeriodista("Santiago", "SCACERES@@@", "SCaceres@gmail.com", "Caceres"));
            Registrar(new UsuarioPeriodista("Milena", "VisM202204", "Viscardi42@gmail.com", "Viscardi"));

            Registrar(new UsuarioOperador("Segio", "SergioPerez1991", "serguiEmail@gmail.com", "Perez"));
            Registrar(new UsuarioOperador("Jose", "JoseAlberto2022", "JoseMail2022@gmail.com", "Alberto"));
            Registrar(new UsuarioOperador("Esteban", "EstebanPass2022", "EstebanConde@gmail.com", "Conde"));
        }
        #endregion
        #endregion

        #region PrimeraParte
        #region RegistrarPeriodista
        public void ValidarRegistro(string Email)
        {
            foreach(UsuarioPeriodista u in usuarios)
            {
                if(u.Email == Email)
                {
        ...
        public void Registrar(UsuarioPeriodista user)
        {
            usuarios.Add(user);
        }
        #endregion
            ...
            if (SeleccionEncontrado != null)
            {
                foreach (Partido p in partidos)
                {
                    if (p.selecciones.Contains(SeleccionEncontrado))
                    {
                        ...
                        {
                            GolesEncontrados = auxIncidencias.Count;
        ...
        #region Buscar resenias con roja (Operador)

        public List<Partido> ListarPartidosConRoja(string IdPeriodista)
        {
            List<Partido> AuxPartidos = new List<Partido>();
            foreach(Resenia r in resenias)
            {
                if(r.UnPeriodista.Email == IdPeriodista)
                {
                    foreach (Incidencia i in incidencias)
                    {
                        if (i.Tipo == "Expulcion")
                        {
                            if (i.unPartido.Equals(r.unPartido))
                            {
                                AuxPartidos.Add(i.unPartido);
                            }
                        }
                    }
                }
        ...
        #region DefinirGanador (Sistema)

        public void DefinirGanadores()
        {
            foreach (Partido partido in partidos)
            {
                DefinirGanadorDePartido(partido);
            }
        }
        public void DefinirGanadorDePartido(Partido unPartido)
        {
            if (unPartido.Estado.Equals("Finalizado"))
            {
                int contadorSeleccion1 = 0;
                int contadorSeleccion2 = 0;
                Seleccion seleccion1 = unPartido.selecciones[0];
                Seleccion seleccion2 = unPartido.selecciones[1];
                bool GanadorPorPenales = false;

                foreach (Incidencia i in incidencias)
                {
                    if (i.unPartido.Equals(unPartido))
                    {
                        if (i.Tipo.Equals("Gol"))
                        {
                            if (seleccion1.jugadores.Contains(i.unJugador))
                            {
                                if (i.unJugador.unPais.Equals(seleccion1.unPais))
                                {
                                    contadorSeleccion1++;
                                }
                            }
                            if (seleccion2.jugadores.Contains(i.unJugador))
                            {
                                if (i.unJugador.unPais.Equals(seleccion2.unPais))
                                {
                                    contadorSeleccion2++;
                                }
                            }
                            else if (i.unJugador.unPais.Equals(seleccion2.unPais))
                            {
                                contadorSeleccion2++;
                            }
                            if (i.Minuto == -1)
                        ...
                        RetornoResultado(contadorSeleccion1, contadorSeleccion2, seleccion1, seleccion2, GanadorPorPenales, unPartido);
                    }
                }
            }
        }

        public void RetornoResultado(int contadorSeleccion1, int contadorSeleccion2, Seleccion seleccion1, Seleccion seleccion2, bool GanadorPorPenales, Partido partido)
        {
            string resultado = "";
            
            if (contadorSeleccion1 > contadorSeleccion2)
            {
                resultado = $"Ganador: {seleccion1.unPais.Nombre}";
            }
            else if (contadorSeleccion1 < contadorSeleccion2)
            {
                resultado = $"Ganador: {seleccion2.unPais.Nombre}"; ;
            }
            else
            {
                if (!GanadorPorPenales)
                {
                    resultado = "Empate";
                }
                else
                {
                    if (contadorSeleccion1 > contadorSeleccion2)
                    {
                        resultado = $"Empate en tiempo de juego. Ganador {seleccion1.unPais.Nombre} en tanda de penales";
                    }
                    else
                    {
                        resultado = $"Empate en tiempo de juego. Ganador {seleccion2.unPais.Nombre} en tanda de penales";
                    }
                }
            }
        ...
        #endregion
        #region Login (All Users)
        //Deberiamos usar esto para el logout quizas?
        public Usuario Login (Usuario unUsuario)
        {
            foreach(Usuario u in usuarios)
            {
                if(u.Email == unUsuario.Email)
                {
                    if(u.Password == unUsuario.Password)
                    {
                        return u;
                    }
                }
        ...
        #endregion
        #region ListarPartidosyaFinalizados (Periodista)
        public List<Partido> ListarPartidosFinalizados()
        {
            List<Partido> PartidosAux = new List<Partido>();
            foreach(Partido p in partidos)
            {
        ...
        #endregion
        #region VerResenias (Periodista)
        public List<Resenia> VerReseniasRealizadas(UsuarioPeriodista periodista)
        {
            List<Resenia> AuxListResenias = new List<Resenia>();
            foreach(Resenia r in resenias)
            {
                if (r.UnPeriodista.Equals(periodista))
                {
                    AuxListResenias.Add(r);
                }
            }
            return AuxListResenias;
        }
        #endregion
        #region VisualizarSelecciones (Operador)
        public List<Seleccion> VisualizarSelecciones()
        {
            selecciones.Sort(); 
            return selecciones;
        }
        #endregion
        #region finalizar partidos(Operador)
        public Partido FinalizarPartido(int partidoId)
        {
        ...
        #endregion
        #region ListarResenias(Periodista)
        public List<Resenia> ListarReseniasDePeriodista(string user)
        {
            Usuario p = null;
            List<Resenia> auxResenias = new List<Resenia>();
            foreach(Usuario periodista in usuarios)
            {
                if (periodista.Email.Equals(user))
                {
                    p = periodista;
                }
            }
        ...
        #endregion
        #region CrearResenia (Periodista)
        public void CrearResenia(Resenia r,string user)
        {
            Usuario userP = null;
            Partido partido = null;
            foreach (Usuario periodista in usuarios)
            {
                if (periodista.Email == user)
                {
                    userP = periodista;
                }
            }
            ...
            if (userP != null && partido!= null)
            {
                r.UnPeriodista = userP;
                r.unPartido = partido;
                resenias.Add(r);
            }
            else
            {
                throw new Exception("No se encontro periodista o el Partido");
            }
        }
        #endregion
        #region obtener incidencias de seleccion (Operador)

        public List<Incidencia> ObtenerGolesDeSeleccion(string CodigoPais, int idPartido)
        {
            List<Incidencia> auxGoles = new List<Incidencia>();
            foreach (Incidencia i in incidencias)
            {
                if (i.unPartido.Id == idPartido && i.unJugador.unPais.CodigoA3 == CodigoPais)
                {
                    if (i.Tipo == "Gol")
                    {
                        auxGoles.Add(i);
        ...
        public List<Incidencia> ObtenerAmarillasDeSeleccion(string CodigoPais, int idPartido)
        {
            List<Incidencia> auxAmarilla = new List<Incidencia>();
            foreach (Incidencia i in incidencias)
            {
                if (i.unPartido.Id == idPartido && i.unJugador.unPais.CodigoA3 == CodigoPais)
                {
                    if (i.Tipo == "Amonestacion")
                    {
                        auxAmarilla.Add(i);
                    }
                }
        ...
        public List<Incidencia> ObtenerExpulcionesDeSeleccion(string CodigoPais, int idPartido)
        {
            List<Incidencia> auxExpulciones = new List<Incidencia>();
            foreach (Incidencia i in incidencias)
            {
                if (i.unPartido.Id == idPartido && i.unJugador.unPais.CodigoA3 == CodigoPais)
                {
                    if (i.Tipo == "Expulsion")
                    {
                        auxExpulciones.Add(i);
                    }
                }
            }
            return auxExpulciones;
        }
        #endregion
        #region Partidos entre dos fechas (Operador)
        public List<Partido> ListarPartidosEntreFechas(DateTime F1, DateTime F2)
        {
            List<Partido> ListAux = new List<Partido>();
            foreach(Partido p in partidos)
            {
                if(p.Estado == "Finalizado")
                {
                    if (DateTime.Compare(p.Fecha,F1) >= 0 && DateTime.Compare(p.Fecha, F2) <= 0)
                    {
                        if(p.Estado == "Finalizado") ListAux.Add(p);
                    }
                }
            }
            return ListAux;
        ...
        #endregion
        #region ListarPeriodistas(Operador)
        public List<UsuarioPeriodista> listarPeriodistas()
        {
            List<UsuarioPeriodista> ListPeriodistas = new List<UsuarioPeriodista>();
            foreach(Usuario u in usuarios)
            {
                if(u is UsuarioPeriodista)
                {
                    ListPeriodistas.Add((UsuarioPeriodista)u);
                }
            }
            ListPeriodistas.Sort();
            return ListPeriodistas;
        }

        #endregion
        #region Partidos que contengan reseñas y rojas (Operador)
        public List<Partido> BuscarReseniasConRoja(string Email)
        {
            List<Partido> aux = new List<Partido>();
            foreach(Resenia r in resenias)
            {
                if(r.UnPeriodista.Email == Email)
                {
                    foreach(Incidencia i in incidencias)
                    {
                        if(i.Tipo == "Expulsion" && i.unPartido.Equals(r.unPartido))
                        {
                            aux.Add(i.unPartido);
                        }
                    }
        ...
        #endregion
        #region Buscar Buscar Selecciones Con Mas Goles (Operador)
        public List<Seleccion> BuscarSeleccionConMasGoles()
        {
            int contadorGoles = 0;
            List<Seleccion> AuxSelecciones = new List<Seleccion>();

            foreach (Seleccion s in selecciones)
            {
                int GolesDeSeleccion = BuscarGoles(s.unPais.Nombre);
                if (GolesDeSeleccion > contadorGoles)
                {
                    contadorGoles = GolesDeSeleccion;
                    AuxSelecciones.Clear();
                    AuxSelecciones.Add(s);
                }else if(GolesDeSeleccion == contadorGoles)
                {
                    AuxSelecciones.Add(s);
                }
            }
            return AuxSelecciones;
        }

        public int BuscarGoles(string nombreSeleccion)
        {
            Seleccion SeleccionEncontrado = null;
            int GolesEncontrados = 0;
            ...
            foreach (Seleccion s in selecciones)
            {
                if (s.unPais.Nombre.Equals(nombreSeleccion))
                {
                    SeleccionEncontrado = s;
                }
            }
                ...
                foreach (Partido p in partidos)
                {
                    if (p.selecciones.Contains(SeleccionEncontrado))
                    {
                        foreach (Incidencia i in incidencias)
                        {
                            if (i.unPartido.Equals(p) && i.Tipo.Equals("Gol"))
                            {
                                if (SeleccionEncontrado.jugadores.Contains(i.unJugador))
                                {
                                    GolesEncontrados++;
                                }
                            }
            ...
            return GolesEncontrados;
        }
        #endregion
        #region ExisteResenia
        public bool ExisteResenia(string periodista, int partido)
        {
            foreach(Resenia r in resenias)
            {
                if(r.partidoId == partido && r.UnPeriodista.Email == periodista)
                {
                    return true;
                }
            }
